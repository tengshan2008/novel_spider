...
def book_test():
    info = {'link': 'https://cl.hn32.xyz/htm_data/1512/20/1758501.html', 'title': '[Rep]妻韵（1-41章）（完结）作者：macooops3', 'type': '[現代奇幻]', 'pages': 23, 'author': 'han1991313', 'date': '2015-12-15', 'id': 1758501}
